...
3. Enter 10.47.61.2 in the "Team # or IP" section
4. Open settings, and click "start a diagnostics server" under FRC Advanced
5. Go to the devices tab

## Updating firmware for CANCoders
1. Connect to the CANCoder devices using Pheonix Tuner X
2. Click on the CANCoder device in the devices page
3. Click "Update firmware" and select the most recent crf file from [CANCoder firmware versions](https://store.ctr-electronics.com/pages/software#:~:text=CTRE%20Device%20Firmware%20Files%20(.zip))

## Reseting offset for CANCoders
1. Connect to the CANCoder devices using Pheonix Tuner X
2. Click on the CANCoder device in the devices page
